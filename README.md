...
`runtime-contract` będzie lokalnym, statycznym CLI do wykrywania niespójności między zmiennymi używanymi w kodzie a ich dokumentacją i dostarczeniem w fazach build/runtime.
